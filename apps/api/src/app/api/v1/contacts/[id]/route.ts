...
export async function GET(
  ...
  try {
    ...
    const contact = await getContactById(ctx.supabase, ctx.organizationId, id);
...
export async function PATCH(
  ...
  try {
    ...
    // Verify the contact is in this organization before mutating anything.
    const existing = await getContactById(ctx.supabase, ctx.organizationId, id);
