...
export function MessageComposer({
  ...
  return (
    <div className="border-t border-border bg-card p-3">
      ...
      {sessionExpired && (
        <div className="mb-2 flex items-center justify-between rounded-lg border border-amber-300/70 bg-amber-50 px-3 py-2 dark:border-amber-500/30 dark:bg-amber-500/10">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-7 text-xs font-semibold text-amber-900 hover:text-amber-950 dark:text-amber-200 dark:hover:text-amber-100"
