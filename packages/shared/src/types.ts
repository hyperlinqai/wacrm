...
export interface Profile {
   ...
   * `@wacrm/roles` rather than comparing this string directly.
   */
...
// ============================================================
// Web Forms — embeddable lead-capture forms for external sites
// ============================================================
...
export interface LeadFormField {
  /** Stable slug — a built-in like "name" / "phone" / "email", or a
   *  generated id for a custom field. Submission payloads key on this. */
  id: string;
...
export interface LeadFormStyle {
  primaryColor?: string;
  buttonText?: string;
  fontFamily?: string;
  borderRadius?: string;
